...
func RegisterAuthenticationHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("POST", pattern_Authentication_Signin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Authentication_Signin_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Authentication_Signin_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_Authentication_Signout_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Authentication_Signout_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
